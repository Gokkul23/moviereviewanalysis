...
//	$review_result_row = $review_result->fetch_assoc();
	...
	$page_title = "GETFLIX" . $result_row['movie_name'];
	...
	<div class="row">
		...
		<div class="col-xs-8">
			...
			<?php	} else { ?>
				<p>
					<a class="btn btn-info" href="addreview.php?id=<?php echo $result_row['movie_id'] ?>" role="button">STAR RATING <i class="fa fa-plus"></i></a>
					<a class="btn btn-info" href="addreview2.php?id=<?php echo $result_row['movie_id'] ?>" role="button">TOMATO RATING <i class="fa fa-plus"></i></a></p>
					<p>
