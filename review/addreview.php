					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control"name="review_rating" id="addRating" required>
								<option name ="2.4" value="1">1</option>
								<option name="1.21"value="2">2</option>
								<option name="0.81" value="3">3</option>
								<option name="0.6"value="4">4</option>
								<option name="0.48"value="5">5</option>
							</select>
						</div>
					</div>
					<div class="form-group">
