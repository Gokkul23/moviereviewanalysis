						...
						<h3><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								<div class="grid images_3_of_2">
									<img src="<?php echo $movie['mov_images']; ?>" alt=""/>
								</div>
								<div class="desc span_3_of_2">
									<p class="p-link" style="font-size:15px">Cast : <?php echo $movie['mov_actors']; ?></p>
									<p class="p-link" style="font-size:15px">Release Date : <?php echo date('d-M-Y',strtotime($movie['mov_date'])); ?></p>
									<p style="font-size:15px"><?php echo $movie['mov_des']; ?></p>
									<a href="<?php echo $movie['mov_trailer']; ?>" target="_blank" class="watch_but">Watch Trailer</a>
									<a href="<?php echo $movie['mov_online']; ?>" target="_blank" class="watch_but">Watch movie</a>
									<a href="<?php echo $movie['mov_download']; ?>" target="_blank" class="watch_but">Download movie</a>
								</div>
								<div class="clear"></div>
							</div>
